...
if (!result.isConfirmed) return;
  ...
  return (
    <div className="page-container">
      ...
      {patient.tests.includes("Chemistry") && <div className="card"><Chemistry title="CHEMISTRY" tests={chemistryResults} onChange={setChemistryResults} readOnly={false} /></div>}
      {patient.tests.includes("Hormones") && (<div className="card"><Chemistry title="HORMONES" 
      presetTests={hormoneTests} tests={hormoneResults} onChange={setHormoneResults} readOnly={false} /></div>
)}
